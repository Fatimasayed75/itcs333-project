  ...
  <?php if ($id === Constants::ADMIN_USER_ID) { ?>
    ...
    <div class="container mx-auto mt-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Manage Rooms Card -->
        <div class="bg-white py-4 px-2 rounded-lg shadow-xl w-full max-w-none relative">
                ...
                <?php foreach ($rooms as $room): ?>
                  <tr class="border-b border-gray-200 hover:bg-gray-100"
                    ...
                    <td class="py-3 px-6 text-center edit-mode hidden">
                      <div class="flex item-center justify-center space-x-4">
                        <button onclick="saveRoom('<?php echo htmlspecialchars($room['roomID']); ?>')"
                          class="text-green-500 hover:text-green-700">
                          <i class="bx bx-check"></i>
                        </button>
                        <button onclick="cancelEdit('<?php echo htmlspecialchars($room['roomID']); ?>')"
