...
<body>
    <div class="modal fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
        <div class="edit-profile-container w-full max-w-md mx-4 bg-white rounded-lg shadow-2xl dark:bg-dark-sidebar-color dark:text-gray-200 transform transition-all duration-300 ease-in-out scale-95 hover:scale-100">
            ...
            <form id="editProfileForm" method="POST" enctype="multipart/form-data" class="p-4 space-y-4">
                <div class="profile-pic-upload flex flex-col items-center mb-4">
                    <div class="relative w-32 h-32 mb-4">
                        ...
                        <label for="profilePicInput" class="absolute bottom-0 right-0 bg-primary-color text-white rounded-full p-2 cursor-pointer hover:bg-primary-color-light transition-colors">
